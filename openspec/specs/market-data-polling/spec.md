...
| Method | Signature |
|--------|-----------|
| `get_securities` | `Online.get_securities(board: str, settlement: str) -> pd.DataFrame` |
| `get_options` | `Online.get_options() -> pd.DataFrame` |
| `get_repos` | `Online.get_repos() -> pd.DataFrame` |
| `get_indices` | `Online.get_indices() -> pd.DataFrame` |
| `get_personal_portfolio` | `Online.get_personal_portfolio() -> pd.DataFrame` |
| `get_order_book` | `Online.get_order_book(symbol: str, settlement: str) -> pd.DataFrame` |
| `get_market_snapshot` | `Online.get_market_snapshot() -> dict[str, pd.DataFrame]` |
